...
Route::post('/review/{review_id}', [ReviewController::class, 'destroy'])->name('review.destroy');

Route::get('/comment/{parent_id}', [CommentController::class, 'show'])->name('comment.show');
...
Route::get('/games/{search_term}', [GameController::class, 'search'])->name('games.search');
